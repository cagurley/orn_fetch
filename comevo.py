...
where exists (select * from [checklist] where a.[id] = [record] and [active] = 1 and [template] in ('9ab2e6d6-dc68-4301-a2f3-e140effd06ba', 'db6d22f8-4ef6-4a3d-9828-9ae3846333d0', '15749872-e53e-44ee-9646-02b180c47601'))
